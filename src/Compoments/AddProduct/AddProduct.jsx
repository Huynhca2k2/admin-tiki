...
import upload_area from '../Assets/uploadimg.jpeg'
...
const AddProduct = () => {
    ...
    const Add_Product = async ()=>{
      ...
      await fetch('https://api-node-tiki.onrender.com/upload',{
        method:'POST',
        headers:{
      ...
      if(responseData.success){
        ...
        console.log(product)
        await fetch('https://api-node-tiki.onrender.com/addproduct',{
          method:'POST',
          headers:{
            Accept:'application/json',
